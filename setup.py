...
setup(
    ...
    version=version,
    packages=['preloaded'],
    package_dir={'preloaded': 'preloaded'},
    description='Python Preloaded - Bundle Python executable with preloaded modules',
    author='Albert Zeyer',
    author_email='albzey@gmail.com',
    url='https://github.com/albertz/python-preloaded',
    license='MIT License',
